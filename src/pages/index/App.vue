  ...
  <div id="app">
    ...
    <div class="main">
        ...
        <div class="search" @mouseover="searchDowm=true" @mouseout="searchDowm = false">
            ...
            <input type="text" name="search" placeholder="歌曲/歌手/歌单/KeON ID" autocomplete="off" v-model="search">
...
export default {
  ...
  computed:{
    ...
    //歌词每行的高度
    lyricRowHeight(){
      return document.querySelector('.lyric_main-content p').offsetHeight;
    }
  },
  watch:{
    ...
    dragLyric(e){
      ...
      function mouseover(e){
        ...
        document.querySelector('.content').style.transition='none';
          ...
          _this.simuLyricIndex = Math.round((-_this.top)/32);
          if(_this.top > 0){
            _this.top = 0;
          }else if(_this.top < -(length-4)*_this.lyricRowHeight){
            _this.top = -(length-4)*32;
          }
      }
